/* Inverse Kinematics for legs and arms of a canonical
   ...
   Please refers to License.txt for information on the license.
*/
#include <math.h>
#include <dynamicsJRLJapan/InverseKinematics.h>

using namespace::dynamicsJRLJapan;

InverseKinematics::InverseKinematics(CjrlHumanoidDynamicRobot *aHS)
{
...
int InverseKinematics::ComputeInverseKinematicsForLegs(MAL_S3x3_MATRIX(,double) &Body_R,
