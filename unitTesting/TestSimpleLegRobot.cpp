...
int main(int argc, char *argv[])
{
  ...
  Joint  * aJoint = (Joint *)aVec[1]; 
  cout << "Try to get the hand." << std::endl;
  ...
  cout << aHDMB->jacobianCenterOfMass() << endl;
  cout << "****************************" << endl;
  ...
  cout << "****************************" << endl;
  // Test rank of the right hand.
//   cout << "Rank of the right hand "<< endl;
//   cout << aHDMB->rightWrist()->rankInConfiguration() << endl;
//   cout << ((Joint *)aHDMB->rightWrist())->getName() << endl;
//   cout << ((Joint *)aHDMB->rightWrist())->getIDinVRML() << endl;

//   cout << "****************************" << endl;
//   // Test rank of the left hand.
//   cout << "Rank of the left hand "<< endl;
//   cout << aHDMB->leftWrist() << endl;
